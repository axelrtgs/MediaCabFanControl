...
#define clamp_val(n, smallest, largest) std::max(smallest, std::min(n, largest))
...
// Based off of datasheet @ https://datasheets.maximintegrated.com/en/ds/MAX31790.pdf
...
public:
    enum class Register : const uint8_t
    {
        ...
        Fan5_Dynamics = 0x0C,
        Fan6_Dynamics = 0x0D,
        User_Byte1 = 0x10, // 2 wide
        Fan_Fault_Status1 = 0x10,
        Fan_Fault_Status2 = 0x10,
    ...
    const Register FanConfig[NR_CHANNEL] = {
        Register::Fan1_Config,
        Register::Fan2_Config,
        Register::Fan3_Config,
        Register::Fan4_Config,
        Register::Fan5_Config,
        Register::Fan6_Config
    };

    const Register FanDynamics[NR_CHANNEL] = {
        Register::Fan1_Dynamics,
        Register::Fan2_Dynamics,
        Register::Fan3_Dynamics,
        Register::Fan4_Dynamics,
        Register::Fan5_Dynamics,
        Register::Fan6_Dynamics
    };
    ...
    const Register PWMTarget[NR_CHANNEL] = {
        Register::PWM_Target1,
        Register::PWM_Target2,
        Register::PWM_Target3,
        Register::PWM_Target4,
        Register::PWM_Target5,
        Register::PWM_Target6
    };

    const Register TachTarget[NR_CHANNEL] = {
        Register::Tach_Target1,
        Register::Tach_Target2,
        Register::Tach_Target3,
        Register::Tach_Target4,
        Register::Tach_Target5,
        Register::Tach_Target6
    };

    const Register Window[NR_CHANNEL] = {
        Register::Window1,
        Register::Window2,
        Register::Window3,
        Register::Window4,
    ...
    enum class Reset : const uint8_t
    {
        Normal = 0b0 << 6,
        Reset = 0b1 << 6
    };

    enum class Run_Standby : uint8_t
    {
        Run = 0b0 << 7,
        Standby = 0b1 << 7
    };
    ...
    enum class FanFaultStatus : const uint8_t
    {
        Normal = 0b0,
        Fault = 0b1
    };

    enum class FanFaultMaskFail : const uint8_t
    {
        Normal = 0b0,
        Masked = 0b1
    };
