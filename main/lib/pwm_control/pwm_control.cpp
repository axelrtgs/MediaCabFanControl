...
esp_err_t PWMControl::getTachRPMByIndex(const uint8_t& index,
                                        uint16_t* tachRPM) {
...
esp_err_t PWMControl::setPWMTargetByIndex(const uint8_t& index,
...
esp_err_t PWMControl::getPWMTargetByIndex(const uint8_t& index,
                                          uint16_t* pwmTarget) {
...
esp_err_t PWMControl::getPWMDutyByIndex(const uint8_t& index,
                                        uint16_t* pwmDuty) {
...
esp_err_t PWMControl::getPWMDutyPercentByIndex(const uint8_t& index,
