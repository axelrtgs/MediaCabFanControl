...
public:
  ...
  void init(config_t *data) {
    ...
    rmt_channel_t tx_channel = static_cast<rmt_channel_t>(RMT_CHANNEL_0 + data->instance_id * 2);
    rmt_channel_t rx_channel = static_cast<rmt_channel_t>(RMT_CHANNEL_1 + data->instance_id * 2);
